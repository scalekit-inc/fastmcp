...
1. Get a [Scalekit account](https://app.scalekit.com/) and grab API credentails such as **Client ID**, **Client Secret** and **Environment URL** from _Dashboard > Developers > Settings_.
